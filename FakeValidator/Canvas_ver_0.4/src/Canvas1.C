...
void Canvas1() {
	//==== Basic information ====
	TString pathData = "$PWD/../../Output_ver_0.4/2016/RunFakeSystUp__RunFakeSystDown__/DATA/";
	TString pathMC = "$PWD/../../Output_ver_0.4/2016/RunFakeSystUp__RunFakeSystDown__/Samples/";
	...
	hSyst->GetYaxis()->SetRangeUser(0, 1500);
	hSyst->Draw("e2");

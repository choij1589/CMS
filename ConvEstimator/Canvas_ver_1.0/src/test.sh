#!/bin/bash
root -l -q 'Canvas_param.C(0, "p_{T}^{e}(1)", "Events / 2GeV", 130, 2)' 
root -l -q 'Canvas_param.C(1, "#eta^{e}(1)", "Events", 60, 2)'
root -l -q 'Canvas_param.C(2, "#phi^{e}(1)", "Events", 40, 2)'
root -l -q 'Canvas_param.C(3, "p_{T}^{e}(2)", "Events / 2GeV", 150, 2)'
root -l -q 'Canvas_param.C(4, "#eta^{e}(2)", "Events", 50, 2)'
root -l -q 'Canvas_param.C(5, "#phi^{e}(2)", "Events", 40, 2)'
root -l -q 'Canvas_param.C(6, "p_{T}^{e}(3)", "Events / 2GeV", 230, 2)'
root -l -q 'Canvas_param.C(7, "#eta^{e}(3)", "Events / 2GeV", 50, 2)'
root -l -q 'Canvas_param.C(8, "#phi^{e}(3)", "Events / 2GeV", 40, 2)'

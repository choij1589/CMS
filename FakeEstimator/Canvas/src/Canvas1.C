...
void Canvas1() {
	...
	TH1D* fakeCentral = fake.GetFakeRatePt(IDSets.at(1), Systs.at(0), "Central", 1).at(0);
	TH1D* fakeJetPt30 = fake.GetFakeRatePt(IDSets.at(1), Systs.at(1), "Central", 1).at(0);
	TH1D* fakeJetPt60 = fake.GetFakeRatePt(IDSets.at(1), Systs.at(3), "Central", 1).at(0);
	TH1D* fakeHadFlavor = fake.GetFakeRatePt(IDSets.at(1), Systs.at(4), "Central", 1).at(0);
	TH1D* fakePromptNormUp = fake.GetFakeRatePt(IDSets.at(1), Systs.at(0), "Central", 1.15).at(0);
	TH1D* fakePromptNormDown = fake.GetFakeRatePt(IDSets.at(1), Systs.at(0), "Central", 0.85).at(0);
